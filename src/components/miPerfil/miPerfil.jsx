                ...
                <div className="content flex-grow-1 crearNotaGlobal">
                    ...
                    <div className='row miPerfilContainer informacionCuentaSeccion'>
                        ...
                        <div className='col textAreaContainer'>
                            <textarea placeholder='Municipalidad de Lanus' className='textAreaComentarios col-auto ms-auto'></textarea>
                        </div>
                    </div>
                    <div className='row miPerfilContainer informacionCuentaSeccion'>
                        <div className='col align-items-center'>
                        ...
                        <div className='col textAreaContainer'>
                            <textarea placeholder='Lanus@gmail.com ' className='textAreaComentarios col-auto ms-auto'></textarea>
                        </div>
                    </div>
                    <div className='row miPerfilContainer informacionCuentaSeccion'>
                        <div className='col align-items-center'>
                        ...
                        <div className='col textAreaContainer'>
                            <textarea placeholder='11-5122-1574' className='textAreaComentarios col-auto ms-auto'></textarea>
                        </div>
                    </div>
                    <div className='row miPerfilContainer informacionCuentaSeccion'>
                        ...
                        <div className="upload-block" onDragOver={handleDragOver} onDrop={handleDrop}>
                            <input
                                type="file"
                                id="fileInput"
                                ref={fileInputRef}
